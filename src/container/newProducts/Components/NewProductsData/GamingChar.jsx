...
function GamingChar() {
  ...
  let newGamingCharNewProductsData = gamingCharNewProductsData.reduce((products, topic) => {
    return products.concat(topic.products);
  }, []);

  let htmlSGamingCharNewProductsData = newGamingCharNewProductsData.map((products, index) => {
    return `
  ...
  let htmlGamingCharNewProductsData = htmlSGamingCharNewProductsData.join('');

  const gamingCharNewProducts = () => {
    return { __html: htmlGamingCharNewProductsData };
  }

  return (
    <div className="new-products-content-right-gaming" id="new-products-content-right-gaming-char-id">
      ...
      <div className="new-products-content-right-gaming-content"
        dangerouslySetInnerHTML={gamingCharNewProducts()}
      ></div>
    </div>
  )
}

export default GamingChar