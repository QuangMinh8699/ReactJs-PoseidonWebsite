...
function GamingWorkstation() {
    ...
    let htmlSGamingWorkstationNewProductsData = newGamingWorkstationNewProductsData.map((products, index) => {
        return `
    ...
    let htmlGamingWorkstationNewProductsData = htmlSGamingWorkstationNewProductsData.join('');

    const gamingWorkstationNewProducts = () => {
        return { __html: htmlGamingWorkstationNewProductsData };
    }

    return (
        <div className="new-products-content-right-gaming-top" id="new-products-content-right-gaming-workstation-id">
...
export default GamingWorkstation